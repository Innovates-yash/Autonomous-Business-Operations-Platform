...
/**
 * Project lifecycle HTTP API. This task implements CRUD with validation and view
 * scoping (Requirements 3.1, 3.2, 3.3, 3.6, 3.7, 3.11); state-machine transitions
 * and requirement analysis are delivered by later tasks.
 *
